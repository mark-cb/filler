...
namespace Filler.API.Controllers
{
    ...
    public class FindSiteController : BaseController
    {
        ...
        IEnumerable<Site> sites = new Site[] { new Site { Id = Guid.Parse("e5aa6b6b-dc73-4e36-b9c4-17933d459358"), Latitude = 54.589752, Longitude = -1.350426, Name = "BP Durham Road", NumberOfPumps = 6 },
